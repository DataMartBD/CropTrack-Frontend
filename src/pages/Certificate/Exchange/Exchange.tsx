...
export default function ExchangePage() {
  ...
  return (
    <div>
      <PageMeta
        title="Exchange - CropTrack"
        description="Exchange Page - CropTrack"
      />
      <PageBreadcrumb pageTitle="Exchange" />
            ...
            <div className="flex gap-3 items-center">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  navigate(`/certificate/exchange?token_no=${selectedToken}`);
                }}
          ...
          <>
            <div className="mb-6 flex items-center justify-between">
              <h2 className="text-xl font-semibold text-gray-800 dark:text-white">
                Exchange Items <span className="text-blue-700">{tokenNo}</span>
              </h2>
            </div>
            <ExchangeForm tokenNo={selectedToken} />
          </>
        )}
      </div>
    </div>
