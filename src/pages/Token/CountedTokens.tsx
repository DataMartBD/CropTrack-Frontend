...
export default function CountedTokens() {
        ...
        cell: (info) => (
          <div className="flex items-center gap-3">
            <button
              onClick={() =>
                navigate(
                  `/certificate/new?token_no=${info.row.original.token_no}`
                )
              }
  ...
  return (
    <div>
      <PageMeta
        title="Counted Tokens - CropTrack"
        description="Counted Tokens - CropTrack"
      />
      <PageBreadcrumb pageTitle="Counted Tokens" />
